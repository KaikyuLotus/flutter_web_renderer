...
class WebRendererPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows *registrar);

  // Creates a plugin that communicates on the given channel.
  WebRendererPlugin(flutter::PluginRegistrarWindows *registrar);

  virtual ~WebRendererPlugin();
...
// static
void WebRendererPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  auto channel = std::make_unique<flutter::MethodChannel<>>(
      registrar->messenger(), kChannelName,
      &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<WebRendererPlugin>(registrar);
...
WebRendererPlugin::WebRendererPlugin(flutter::PluginRegistrarWindows *registrar)
...
WebRendererPlugin::~WebRendererPlugin() {
  registrar_->UnregisterTopLevelWindowProcDelegate(window_proc_id_);
}

void WebRendererPlugin::HandleMethodCall(
...
std::optional<LRESULT> WebRendererPlugin::HandleWindowProc(HWND hwnd,
                                                          UINT message,
                                                          WPARAM wparam,
                                                          LPARAM lparam) {
...
void WebRendererPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  WebRendererPlugin::RegisterWithRegistrar(
