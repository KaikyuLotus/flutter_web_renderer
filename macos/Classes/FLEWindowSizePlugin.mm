...
@interface FLEWebRendererPlugin ()
...
@implementation FLEWebRendererPlugin {
...
+ (void)registerWithRegistrar:(id<FlutterPluginRegistrar>)registrar {
  ...
  FLEWebRendererPlugin *instance = [[FLEWebRendererPlugin alloc] initWithChannel:channel
                                                                     registrar:registrar];
...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
  id methodResult = nil;
  if ([call.method isEqualToString:kSetWindowFrameMethod]) {
