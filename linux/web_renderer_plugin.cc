...
static FlMethodResponse* get_screen_list(FlWebRendererPlugin* self) {
...
static FlMethodResponse* get_window_info(FlWebRendererPlugin* self) {
...
static void update_window_geometry(FlWebRendererPlugin* self) {
...
static FlMethodResponse* set_window_minimum_size(FlWebRendererPlugin* self,
                                                 FlValue* args) {
  if (fl_value_get_type(args) != FL_VALUE_TYPE_LIST ||
...
static FlMethodResponse* set_window_maximum_size(FlWebRendererPlugin* self,
                                                 FlValue* args) {
  if (fl_value_get_type(args) != FL_VALUE_TYPE_LIST ||
      fl_value_get_length(args) != 2) {
    return FL_METHOD_RESPONSE(fl_method_error_response_new(
...
static FlMethodResponse* set_window_title(FlWebRendererPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_window_visible(FlWebRendererPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* get_window_minimum_size(FlWebRendererPlugin* self) {
...
static FlMethodResponse* get_window_maximum_size(FlWebRendererPlugin* self) {
  g_autoptr(FlValue) size = fl_value_new_list();
